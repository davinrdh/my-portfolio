      ...
      <Row className="hero flex-md-row-reverse">
        ...
        <Col md={12} lg={6} sm={12} className="text-hero offset-md-1">
          <div>
            ...
            <h1 onMouseEnter={textEnter} onMouseLeave={textLeave}>I'm Davin Ridha,</h1>
            <h1 onMouseEnter={textEnter} onMouseLeave={textLeave}><b>Front End Developer.</b></h1>
            <p>Passionate JUNIOR FRONT END DEVELOPER with a keen interest in creating engaging web experiences and continuous learning.</p>
          </div>
        </Col>
      </Row>
      <Skill />
